...
window.onload = function () {
    ...
    const color = document.querySelectorAll('.catalog figure span'),
    ...
    for(let i = 0; i < color.length; i++) {
        for(let j = 0; j < color.length; j++) {
            color[j].addEventListener('click', () => {
                ...
                let activeModel = color[j].dataset.color;
                ...
                setTimeout(() => {
                    ...
                    for(let i = 0; i < link.length; i++) {
                        link[i].href = `img/catalog/${activeModel}/${i + 1}-1000.jpg`;
                        photo[i].src = `img/catalog/${activeModel}/${i + 1}.jpg`;
                    }
                }, 600);
                setTimeout(() => {
